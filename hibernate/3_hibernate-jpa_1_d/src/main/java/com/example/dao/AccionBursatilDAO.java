...
/**
 * Home object for domain model class AccionBursatilEntity.
 * @see com.example.entity.AccionBursatilEntity
...
public class AccionBursatilDAO {
	...
	public AccionBursatil findById(Integer id) {
		...
		try {
			AccionBursatil instance = entityManager.find(
					AccionBursatil.class, id);
